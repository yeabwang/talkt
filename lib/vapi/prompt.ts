...
export function systemPrompt(job: InterviewJob): string {
  ...
  return [
    ...
    "- When the final question is done (including any follow-ups), your final spoken turn must be one or two full sentences that include all three ideas: the interview is complete, their report or feedback is being prepared now, and they will see it in a moment.",
    "- A good final turn is: \"That's the interview complete. Thank you for the conversation. Your report is being prepared now, and you'll see it in a moment. Take care.\"",
    "- Say that whole closing first and let it finish. THEN end the call. Never end after only 'goodbye', 'bye', 'thanks', or 'take care' — those are incomplete closings.",
    "- Never start a new question after the closing, and never add anything after it.",
    "",
